...
<div class="page my-3">
    <div class="grid gap-4 notice-layout">
        ...
        <div class="bg-surface rounded shadow-sm p-4" style="width: 100%;">
            <h2 class="mb-4 notice-title">▣ 1:1 문의  <!-- 글쓰기 버튼 -->
                <a href="${pageContext.request.contextPath}/qnaWrite" class="btn btn-main">글쓰기</a></h2>
            ...
            <table class="notice-table border" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td class="py-2 px-3">
                        <a href="${pageContext.request.contextPath}/qnaText?id=${data.no}" class="text-main">
                            ${data.title}aass
                        </a>
